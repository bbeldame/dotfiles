...
alias pulldotfiles="git -C ~/Development/perso/dotfile pull && sh ~/Development/perso/dotfile/install.sh"
alias statusdotfiles="git -C ~/Development/perso/dotfile fetch"
